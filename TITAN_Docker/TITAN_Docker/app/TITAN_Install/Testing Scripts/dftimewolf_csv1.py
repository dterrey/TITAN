...
def main():
    ...
    # Prompt the user for sketch_id
    sketch_id = input("Enter the Sketch ID: ")
    ...
    for csv_file_path in csv_files:
        ...
        try:
            ...
            upload_to_timesketch(args.timesketch_username, args.timesketch_password, args.timesketch_endpoint, sketch_id, csv_file_path)
